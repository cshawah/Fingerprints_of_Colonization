...
write.csv(mean_gdp, "Final_Project_Draft/mean_gdp.csv")
write.csv(mean_cm, "Final_Project_Draft/mean_cm.csv")
write.csv(mean_lit, "Final_Project_Draft/mean_lit.csv")
write.csv(mean_hdi, "Final_Project_Draft/mean_hdi.csv")
...
Changes to make for final version:
 ...
 - Disclaimer Story Page
 - Color Freezing? Change themes?
 - Change Graph Titles
 - Fix link to ICOW
 - Make a regression somewhere
